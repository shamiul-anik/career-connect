...
const Footer = () => {
  return (
    <footer className="p-10 bg-slate-950 text-slate-300 mt-8 lg:mt-32">
      <div className="footer max-w-7xl mx-auto grid gap:8 lg:gap-28 lg:grid-cols-5">
        <div className="col-span-2">
          <h3 className="text-3xl text-white font-bold">CareerConnect</h3>
          <p className="text-justify mt-2 mb-4">If you have any questions or feedback about anything, please don't hesitate to contact us. We're here to help you with the best answers of you questions and we want to help you to succeed in your job search and career goals.</p>
      ...
      <div className="max-w-7xl text-sm lg:text-base mx-auto mt-8 pt-6 border-t flex flex-col gap-2 lg:flex-row justify-between items-center">
        ...
        <p>Powered by <Link to="/" className="link link-hover">CareerConnect</Link></p>
      </div>
    </footer>
  );
};
